...
from services.services import initialize_services, get_workflow_management_service
from services.config import get_service_config


async def import_workflow(entity_name: str, model_version: str, file_path: str):
    ...
    with open(full_path, 'r') as f:
        ...
        workflows = [workflow_data] if isinstance(workflow_data, dict) else workflow_data

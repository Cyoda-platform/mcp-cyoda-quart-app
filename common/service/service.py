...
class EntityServiceImpl(EntityService):
    ...
    def __init__(
        self, repository: CrudRepository, model_registry: Dict[str, Any] = None
    ):
        """
    ...
    @classmethod
    def get_instance(
        cls, repository: CrudRepository = None, model_registry: Dict[str, Any] = None
    ) -> "EntityServiceImpl":
        """
    ...
    def _create_entity_response(
        self, data: Any, entity_id: str = None, state: str = None
    ) -> EntityResponse:
        """
    ...
    def _handle_repository_error(
        self, data: Any, operation: str, entity_class: str = None, entity_id: str = None
    ) -> Any:
        """
    ...
    async def update_item(
        ...
        resp = await self._repository.update(
            meta=meta, technical_id=technical_id, entity=entity
        )
        return resp
    ...
    async def get_transitions(self, token: str, technical_id: str, meta: Any) -> Any:
        ...
        resp = await self._repository.get_transitions(
            meta=meta, technical_id=technical_id
        )
        return resp

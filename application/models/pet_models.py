...
class PetResponse(BaseModel):
    ...
    species: Optional[str] = Field(None, description="Pet species")
    breed: Optional[str] = Field(None, description="Pet breed")
    age_months: Optional[int] = Field(None, alias="ageMonths", description="Pet age in months")
    ...
    health_status: Optional[str] = Field(None, alias="healthStatus", description="Health status")
    vaccination_status: Optional[str] = Field(None, alias="vaccinationStatus", description="Vaccination status")
    adoption_status: Optional[str] = Field(None, alias="adoptionStatus", description="Adoption status")
    special_needs: Optional[str] = Field(None, alias="specialNeeds", description="Special needs")
    arrival_date: Optional[str] = Field(None, alias="arrivalDate", description="Arrival date")

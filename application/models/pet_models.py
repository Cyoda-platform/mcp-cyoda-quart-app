...
class PetQueryParams(BaseModel):
    ...
    adoption_status: Optional[str] = Field(None, alias="adoptionStatus", description="Filter by adoption status")
    health_status: Optional[str] = Field(None, alias="healthStatus", description="Filter by health status")
    min_age: Optional[int] = Field(None, alias="minAge", description="Minimum age in months")
    max_age: Optional[int] = Field(None, alias="maxAge", description="Maximum age in months")
    min_price: Optional[Decimal] = Field(None, alias="minPrice", description="Minimum price")
    max_price: Optional[Decimal] = Field(None, alias="maxPrice", description="Maximum price")
...
class PetSearchRequest(BaseModel):
    ...
    adoption_status: Optional[str] = Field(None, alias="adoptionStatus", description="Adoption status")
    health_status: Optional[str] = Field(None, alias="healthStatus", description="Health status")
    color: Optional[str] = Field(None, description="Pet color")


class TransitionRequest(BaseModel):
    """Request model for triggering workflow transitions"""
    transition_name: str = Field(..., alias="transitionName", description="Name of transition to trigger")
...
class PetResponse(BaseModel):
    ...
    entity_id: Optional[str] = Field(None, alias="entityId", description="Pet entity ID")
    name: str = Field(..., description="Pet name")
    species: str = Field(..., description="Pet species")
    breed: str = Field(..., description="Pet breed")
    age_months: int = Field(..., alias="ageMonths", description="Pet age in months")
    age_display: Optional[str] = Field(None, alias="ageDisplay", description="Human-readable age")
    color: str = Field(..., description="Pet color")
    size: str = Field(..., description="Pet size")
    gender: str = Field(..., description="Pet gender")
    price: Decimal = Field(..., description="Adoption fee")
    description: str = Field(..., description="Pet description")
    health_status: str = Field(..., alias="healthStatus", description="Health status")
    vaccination_status: str = Field(..., alias="vaccinationStatus", description="Vaccination status")
    adoption_status: str = Field(..., alias="adoptionStatus", description="Adoption status")
    special_needs: Optional[str] = Field(None, alias="specialNeeds", description="Special needs")
    arrival_date: str = Field(..., alias="arrivalDate", description="Arrival date")
    state: Optional[str] = Field(None, description="Workflow state")
    available_for_adoption: Optional[bool] = Field(None, alias="availableForAdoption", description="Available for adoption")
    created_at: Optional[str] = Field(None, alias="createdAt", description="Creation timestamp")
    updated_at: Optional[str] = Field(None, alias="updatedAt", description="Update timestamp")
...
class PetStatisticsResponse(BaseModel):
    ...
    available_pets: int = Field(..., alias="availablePets", description="Number of available pets")
    reserved_pets: int = Field(..., alias="reservedPets", description="Number of reserved pets")
    adopted_pets: int = Field(..., alias="adoptedPets", description="Number of adopted pets")
    by_species: Dict[str, int] = Field(..., alias="bySpecies", description="Count by species")
    by_size: Dict[str, int] = Field(..., alias="bySize", description="Count by size")
    by_health_status: Dict[str, int] = Field(..., alias="byHealthStatus", description="Count by health status")
    average_age_months: float = Field(..., alias="averageAgeMonths", description="Average age in months")
    average_price: float = Field(..., alias="averagePrice", description="Average adoption fee")


# Adoption-specific Models
class ReservationRequest(BaseModel):
    """Request model for pet reservation"""
    adopter_name: str = Field(..., alias="adopterName", description="Name of potential adopter")
    adopter_email: str = Field(..., alias="adopterEmail", description="Email of potential adopter")
    adopter_phone: Optional[str] = Field(None, alias="adopterPhone", description="Phone of potential adopter")
...
class AdoptionRequest(BaseModel):
    ...
    adopter_email: str = Field(..., alias="adopterEmail", description="Email of adopter")
    adopter_phone: Optional[str] = Field(None, alias="adopterPhone", description="Phone of adopter")
    adoption_fee_paid: Decimal = Field(..., alias="adoptionFeePaid", description="Adoption fee paid")
    notes: Optional[str] = Field(None, description="Additional notes")


class HealthUpdateRequest(BaseModel):
    """Request model for health status updates"""
    health_status: str = Field(..., alias="healthStatus", description="New health status")
    vaccination_status: Optional[str] = Field(None, alias="vaccinationStatus", description="New vaccination status")

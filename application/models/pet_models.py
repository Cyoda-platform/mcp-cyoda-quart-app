...
class PetUpdateQueryParams(BaseModel):
    ...
    transition: Optional[str] = Field(
        default=None,
        description="Workflow transition to trigger after update"
    )
...
class PetListResponse(BaseModel):
    ...
    pets: List[Dict[str, Any]] = Field(
        ...,
        description="List of pet entities"
    )
    total: int = Field(
        ...,
...
class PetSearchResponse(BaseModel):
    ...
    pets: List[Dict[str, Any]] = Field(
        ...,
        description="List of matching pet entities"
    )
    total: int = Field(
        ...,
...
class ExistsResponse(BaseModel):
    ...
    entity_id: str = Field(
        ...,
        alias="entityId",
        description="ID of the entity checked"
    )

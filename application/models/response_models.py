...
class DataExtractionListResponse(BaseModel):
    ...
    extractions: List[Dict[str, Any]] = Field(..., description="List of data extractions")
...
class DataExtractionSearchResponse(BaseModel):
    ...
    extractions: List[Dict[str, Any]] = Field(..., description="List of matching data extractions")

...
class ValidationErrorResponse(BaseModel):
    ...
    field_errors: Optional[Dict[str, List[str]]] = Field(default=None, alias="fieldErrors", description="Field-specific errors")
...
class BookingResponse(BaseModel):
    ...
    booking_id: Optional[int] = Field(default=None, alias="bookingId", description="External booking ID")
    ...
    bookingdates: Dict[str, str] = Field(..., description="Check-in and check-out dates")
    ...
    retrieved_at: Optional[str] = Field(default=None, alias="retrievedAt", description="Retrieval timestamp")
    nights_count: Optional[int] = Field(default=None, alias="nightsCount", description="Number of nights")
    price_per_night: Optional[float] = Field(default=None, alias="pricePerNight", description="Price per night")
...
class BookingSearchResponse(BaseModel):
    ...
    entities: List[Dict[str, Any]] = Field(..., description="List of matching booking entities")
    total: int = Field(..., description="Total number of matches")
    search_criteria: Optional[Dict[str, Any]] = Field(default=None, alias="searchCriteria", description="Applied search criteria")
...
class ReportResponse(BaseModel):
    ...
    display_format: str = Field(..., alias="displayFormat", description="Display format")
    ...
    booking_count: int = Field(..., alias="bookingCount", description="Number of bookings analyzed")
    summary: Optional[Dict[str, Any]] = Field(default=None, description="Report summary statistics")
    date_range_stats: Optional[List[Dict[str, Any]]] = Field(default=None, alias="dateRangeStats", description="Date range statistics")
    filter_criteria: Optional[Dict[str, Any]] = Field(default=None, alias="filterCriteria", description="Applied filter criteria")
    state: str = Field(..., description="Current workflow state")
...
class CountResponse(BaseModel):
    ...
    entity_type: Optional[str] = Field(default=None, alias="entityType", description="Type of entity counted")
...
class DeleteResponse(BaseModel):
    ...
    entity_id: str = Field(..., alias="entityId", description="ID of the deleted entity")
...
class TransitionResponse(BaseModel):
    ...
    transition_name: str = Field(..., alias="transitionName", description="Name of the executed transition")
...
class TransitionsResponse(BaseModel):
    ...
    current_state: Optional[str] = Field(default=None, alias="currentState", description="Current workflow state")
    available_transitions: List[str] = Field(..., alias="availableTransitions", description="List of available transitions")


class BulkOperationResponse(BaseModel):
    """Response model for bulk operations."""

    total_processed: int = Field(..., alias="totalProcessed", description="Total number of entities processed")
    successful: int = Field(..., description="Number of successful operations")
    failed: int = Field(..., description="Number of failed operations")
    errors: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of errors for failed operations")
...
class ReportDisplayResponse(BaseModel):
    ...
    booking_count: int = Field(..., alias="bookingCount", description="Number of bookings analyzed")
    revenue_by_deposit: Dict[str, float] = Field(..., alias="revenueByDeposit", description="Revenue breakdown by deposit status")
    date_ranges: Optional[List[Dict[str, Any]]] = Field(default=None, alias="dateRanges", description="Date range statistics")
    filters_applied: Optional[Dict[str, Any]] = Field(default=None, alias="filtersApplied", description="Applied filter criteria")
...
class BookingStatsResponse(BaseModel):
    ...
    average_booking_price: float = Field(..., alias="averageBookingPrice", description="Average booking price")
    deposit_paid_percentage: float = Field(..., alias="depositPaidPercentage", description="Percentage with deposit paid")
    average_nights_per_booking: float = Field(..., alias="averageNightsPerBooking", description="Average nights per booking")
    date_range: Optional[Dict[str, str]] = Field(default=None, alias="dateRange", description="Date range for statistics")

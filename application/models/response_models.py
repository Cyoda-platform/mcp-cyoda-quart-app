...
class WeatherStationListResponse(BaseModel):
    ...
    stations: List[WeatherStationResponse] = Field(
...
class WeatherDataResponse(BaseModel):
    ...
    temperature_max: Optional[float] = Field(
        default=None, description="Maximum temperature (°C)"
    )
    temperature_min: Optional[float] = Field(
        default=None, description="Minimum temperature (°C)"
    )
    temperature_mean: Optional[float] = Field(
        default=None, description="Mean temperature (°C)"
    )
    precipitation_total: Optional[float] = Field(
        default=None, description="Total precipitation (mm)"
    )
    ...
    wind_direction: Optional[float] = Field(
        default=None, description="Wind direction (degrees)"
    )
    pressure_sea_level: Optional[float] = Field(
        default=None, description="Sea level pressure (kPa)"
    )
    pressure_station: Optional[float] = Field(
        default=None, description="Station pressure (kPa)"
    )
    ...
    data_completeness_score: Optional[float] = Field(
        default=None, description="Data completeness score"
    )
...
class WeatherDataListResponse(BaseModel):
    ...
    weather_data: List[WeatherDataResponse] = Field(
...
class TransitionsResponse(BaseModel):
    ...
    available_transitions: List[str] = Field(
        ..., description="Available transition names"
    )

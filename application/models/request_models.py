...
class ProductQueryParams(BaseModel):
    ...
    performance_score_min: Optional[float] = Field(None, alias="performanceScoreMin", description="Minimum performance score")
    performance_score_max: Optional[float] = Field(None, alias="performanceScoreMax", description="Maximum performance score")
    trend_indicator: Optional[str] = Field(None, alias="trendIndicator", description="Filter by trend indicator")
    restock_needed: Optional[bool] = Field(None, alias="restockNeeded", description="Filter by restock needed flag")
...
class ReportQueryParams(BaseModel):
    ...
    state: Optional[str] = Field(None, description="Filter by workflow state")
    period_start: Optional[str] = Field(None, alias="periodStart", description="Filter by period start date")
    period_end: Optional[str] = Field(None, alias="periodEnd", description="Filter by period end date")
    offset: int = Field(0, description="Pagination offset")
    limit: int = Field(50, description="Pagination limit")
...
class DataExtractionQueryParams(BaseModel):
    ...
    job_type: Optional[str] = Field(None, alias="jobType", description="Filter by job type")
    execution_status: Optional[str] = Field(None, alias="executionStatus", description="Filter by execution status")
    state: Optional[str] = Field(None, description="Filter by workflow state")
    scheduled_after: Optional[str] = Field(None, alias="scheduledAfter", description="Filter by scheduled time (after)")
    scheduled_before: Optional[str] = Field(None, alias="scheduledBefore", description="Filter by scheduled time (before)")
    offset: int = Field(0, description="Pagination offset")
    limit: int = Field(50, description="Pagination limit")
...
class TransitionRequest(BaseModel):
    ...
    transition_name: str = Field(..., alias="transitionName", description="Name of the transition to trigger")
    parameters: Optional[Dict[str, Any]] = Field(None, description="Optional parameters for the transition")

...
class PetHamsterQueryParams(BaseModel):
    ...
    limit: int = Field(
        default=50, ge=1, le=1000, description="Maximum number of records to return"
    )
...
class SearchRequest(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="Search by hamster name")
    breed: Optional[str] = Field(default=None, description="Search by hamster breed")
    mood: Optional[str] = Field(default=None, description="Search by current mood")
    current_location: Optional[str] = Field(
        default=None, alias="currentLocation", description="Search by current location"
    )

...
class SubscriberQueryParams(BaseModel):
    ...
    subscription_status: Optional[str] = Field(
        None, alias="subscriptionStatus", description="Filter by subscription status"
    )
...
class SubscriberSearchRequest(BaseModel):
    ...
    subscription_status: Optional[str] = Field(
        None, alias="subscriptionStatus", description="Search by subscription status"
    )
...
class CatFactQueryParams(BaseModel):
    ...
    is_used: Optional[bool] = Field(
        None, alias="isUsed", description="Filter by usage status"
    )
    is_appropriate: Optional[bool] = Field(
        None, alias="isAppropriate", description="Filter by appropriateness"
    )
    state: Optional[str] = Field(None, description="Filter by workflow state")
    offset: int = Field(0, description="Pagination offset")
    limit: int = Field(50, description="Pagination limit")
...
class CatFactSearchRequest(BaseModel):
    ...
    fact_text: Optional[str] = Field(
        None, alias="factText", description="Search in fact text"
    )
    source: Optional[str] = Field(None, description="Search by source")
    is_used: Optional[bool] = Field(
        None, alias="isUsed", description="Search by usage status"
    )
    is_appropriate: Optional[bool] = Field(
        None, alias="isAppropriate", description="Search by appropriateness"
    )
...
class EmailCampaignQueryParams(BaseModel):
    ...
    campaign_date: Optional[str] = Field(
        None, alias="campaignDate", description="Filter by campaign date"
    )
    state: Optional[str] = Field(None, description="Filter by workflow state")
    offset: int = Field(0, description="Pagination offset")
    limit: int = Field(50, description="Pagination limit")
...
class EmailCampaignSearchRequest(BaseModel):
    ...
    campaign_name: Optional[str] = Field(
        None, alias="campaignName", description="Search by campaign name"
    )
    status: Optional[str] = Field(None, description="Search by status")
    campaign_date: Optional[str] = Field(
        None, alias="campaignDate", description="Search by campaign date"
    )
    cat_fact_id: Optional[str] = Field(
        None, alias="catFactId", description="Search by cat fact ID"
    )

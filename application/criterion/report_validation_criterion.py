    ...
    async def check(self, entity: CyodaEntity, **kwargs: Any) -> bool:
        ...
        try:
            ...
            if report_entity.filter_criteria:
                ...
                valid_filter_keys = [
                    "depositpaid", "min_price", "max_price", 
                    "start_date", "end_date", "firstname", "lastname"
                ]
                ...
                if "start_date" in report_entity.filter_criteria or "end_date" in report_entity.filter_criteria:
            ...
            if not report_entity.data_source or len(report_entity.data_source.strip()) == 0:
                self.logger.warning(
            ...
            if report_entity.report_type == "date_range":
                if not report_entity.filter_criteria or (
                    "start_date" not in report_entity.filter_criteria and 
                    "end_date" not in report_entity.filter_criteria
                ):
                    self.logger.warning(

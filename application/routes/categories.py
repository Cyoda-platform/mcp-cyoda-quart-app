...
async def trigger_transition(
    ...
    try:
        ...
        logger.info("Executed transition '%s' on Category %s", data.transition_name, entity_id)
        ...
        logger.exception("Error executing transition on Category %s: %s", entity_id, str(e))
        return jsonify({"error": str(e)}), 500

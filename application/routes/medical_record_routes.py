...
async def get_medical_records():
    ...
    try:
        ...
        return (
            jsonify({"error": "Failed to retrieve medical records", "message": str(e)}),
            500,
        )
...
async def get_medical_record(record_id: str):
    ...
    try:
        ...
        try:
            record = await entity_service.find_by_business_id(
        ...
        return (
            jsonify({"error": "Failed to retrieve medical record", "message": str(e)}),
            500,
        )
...
async def create_medical_record():
    ...
    try:
        ...
        return (
            jsonify({"error": "Failed to create medical record", "message": str(e)}),
            500,
        )
...
async def update_medical_record(record_id: str):
    ...
    try:
        ...
        return (
            jsonify({"error": "Failed to update medical record", "message": str(e)}),
            500,
        )
...
async def delete_medical_record(record_id: str):
    ...
    try:
        ...
        return (
            jsonify({"error": "Failed to delete medical record", "message": str(e)}),
            500,
        )

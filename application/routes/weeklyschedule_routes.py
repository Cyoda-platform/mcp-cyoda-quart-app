...
weeklyschedule_bp = Blueprint('weekly_schedules', __name__, url_prefix='/api/weekly-schedules')
...
async def create_weeklyschedule():
    ...
    try:
        ...
        response = await entity_service.save(schedule_data, "weeklyschedule", ENTITY_VERSION)
...
async def get_weeklyschedule(schedule_id: str):
    ...
    try:
        response = await entity_service.get_by_id(schedule_id, "weeklyschedule", ENTITY_VERSION)
...
async def execute_weeklyschedule(schedule_id: str):
    ...
    try:
        ...
        current_response = await entity_service.get_by_id(schedule_id, "weeklyschedule", ENTITY_VERSION)

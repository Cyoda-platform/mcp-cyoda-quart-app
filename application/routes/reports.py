...
async def list_reports(
    ...
    try:
        ...
        if query_args.analysis_id:
            search_conditions["analysisId"] = query_args.analysis_id

        if query_args.delivery_status:
            search_conditions["deliveryStatus"] = query_args.delivery_status

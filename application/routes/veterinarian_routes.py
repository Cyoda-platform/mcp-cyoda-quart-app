...
async def get_veterinarians():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to retrieve veterinarians', 'message': str(e)}), 500
...
async def get_veterinarian(vet_id: str):
    ...
    try:
        ...
        return jsonify({'error': 'Failed to retrieve veterinarian', 'message': str(e)}), 500
...
async def create_veterinarian():
    ...
    try:
        ...
        required_fields = ['first_name', 'last_name', 'email', 'phone', 'license_number']
        ...
        return jsonify({'error': 'Failed to create veterinarian', 'message': str(e)}), 500
...
async def update_veterinarian(vet_id: str):
    ...
    try:
        ...
        return jsonify({'error': 'Failed to update veterinarian', 'message': str(e)}), 500
...
async def delete_veterinarian(vet_id: str):
    ...
    try:
        ...
        return jsonify({'error': 'Failed to delete veterinarian', 'message': str(e)}), 500

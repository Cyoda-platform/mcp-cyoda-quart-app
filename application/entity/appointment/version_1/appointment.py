...
class Appointment(CyodaEntity):
    ...
    duration_minutes: int = Field(..., ge=15, le=480, description="Expected duration in minutes")
    ...
    estimated_cost: Optional[float] = Field(None, ge=0, description="Estimated cost of the appointment")
    ...
    def validate_appointment_date(cls, v):
        ...
        try:
            ...
            if "Appointment date must be in the future" in str(e):
                raise e
            raise ValueError("Invalid appointment date format. Use ISO format (YYYY-MM-DDTHH:MM:SSZ)")
    ...
    def is_upcoming(self) -> bool:
        ...
        try:
            appointment_dt = datetime.fromisoformat(self.appointment_date.replace('Z', '+00:00'))

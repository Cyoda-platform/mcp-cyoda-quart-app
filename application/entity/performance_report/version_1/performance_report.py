...
class PerformanceReport(CyodaEntity):
    ...
    recommendations: List[str] = Field(
        default_factory=list, description="Business recommendations based on analysis"
    )
    ...
    def calculate_summary_metrics(
        ...
        for product in product_data_list:
            ...
            category_stats[category]["turnover"] += product.get(
        ...
        self.average_inventory_turnover = total_turnover / max(
            self.total_products_analyzed, 1
        )
        ...
        for category, stats in category_stats.items():
            ...
            category_stats[category]["avg_revenue_per_product"] = (
                stats["revenue"] / count
            )

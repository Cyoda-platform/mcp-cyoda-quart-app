...
class Order(CyodaEntity):
    ...
    petId: str = Field(
        ..., 
        alias="petId",
        description="Reference to the pet being ordered"
    )
    userId: str = Field(
        ..., 
        alias="userId",
    ...
    @classmethod
    def validate_shipping_address(cls, v: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    @field_validator("shipDate", "orderDate", "estimatedDelivery", "approvedAt", "deliveredAt")
    @classmethod
    def validate_date_format(cls, v: Optional[str]) -> Optional[str]:
        ...
        try:
            ...
            raise ValueError("Date must be in ISO 8601 format (e.g., '2023-12-25T10:30:00Z')")

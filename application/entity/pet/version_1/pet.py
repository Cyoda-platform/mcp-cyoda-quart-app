...
class Pet(CyodaEntity):
    ...
    photoUrls: List[str] = Field(
        ..., alias="photoUrls", description="URLs to pet photos", min_length=1
    )
    ...
    tags: Optional[List[Dict[str, Any]]] = Field(
        default_factory=list, description="Tags for categorization with id and name"
    )
    breed: Optional[str] = Field(default=None, description="Pet breed information")
    age: Optional[int] = Field(default=None, description="Pet age in months", ge=0)
    price: Optional[float] = Field(default=None, description="Pet price in USD", ge=0.0)
    ...
    viewCount: Optional[int] = Field(
        default=0, alias="viewCount", description="Number of times pet has been viewed"
    )
    reservedAt: Optional[str] = Field(
        default=None, alias="reservedAt", description="Timestamp when pet was reserved"
    )
    ...
    soldAt: Optional[str] = Field(
        default=None, alias="soldAt", description="Timestamp when pet was sold"
    )
    soldPrice: Optional[float] = Field(
        default=None, alias="soldPrice", description="Final sale price"
    )

...
class StartReportGenerationProcessor(CyodaProcessor):
    ...
    async def _get_analyses_by_period(self, start_date: str, end_date: str) -> List[Dict[str, Any]]:
        """
    ...
    def _calculate_toxicity_summary(self, analyses: List[Dict[str, Any]]) -> Dict[str, Any]:
        """

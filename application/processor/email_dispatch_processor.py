...
class EmailDispatchProcessor(CyodaProcessor):
    ...
    async def process(self, entity: CyodaEntity, **kwargs: Any) -> CyodaEntity:
        ...
        try:
            ...
            if isinstance(entity, EmailNotification) or hasattr(entity, 'mark_as_failed'):
                try:
    ...
    def _handle_delivery_failure(self, email_notification: EmailNotification, error: str) -> None:
        """

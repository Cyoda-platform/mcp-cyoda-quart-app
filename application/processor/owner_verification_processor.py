...
class OwnerVerificationProcessor(CyodaProcessor):
    ...
    async def process(self, entity: CyodaEntity, **kwargs) -> CyodaEntity:
        ...
        try:
            ...
            logger.exception(f"Failed to process owner verification for entity {entity.entity_id}")
            raise ProcessorError(self.name, f"Failed to process owner verification: {str(e)}", e)

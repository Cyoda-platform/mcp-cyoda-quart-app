...
class OwnerRegistrationProcessor(CyodaProcessor):
    ...
    async def process(self, entity: CyodaEntity, **kwargs) -> CyodaEntity:
        ...
        try:
            ...
            logger.exception(f"Failed to process owner registration for entity {entity.entity_id}")
            raise ProcessorError(self.name, f"Failed to process owner registration: {str(e)}", e)

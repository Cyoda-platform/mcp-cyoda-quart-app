...
class PetActivationProcessor(CyodaProcessor):
    ...
    def __init__(self, name: str = "PetActivationProcessor", description: str = ""):
        super().__init__(
            ...
            or "Activate a registered pet for appointments and services",
        )
    ...
    async def process(self, entity: CyodaEntity, **kwargs) -> CyodaEntity:
        ...
        try:
            ...
            logger.info(
                f"Successfully activated pet {pet.pet_id} for owner {pet.owner_id}"
            )
    ...
    async def _create_welcome_notification(self, owner_id: str, pet_name: str) -> None:
        ...
        logger.info(
            f"Welcome notification created for owner {owner_id}: {notification_message}"
        )

...
from application.routes import (catfact_bp, emaildelivery_bp, reporting_bp,
                                subscriber_bp, weeklyschedule_bp)
...
def configure_application_schema(app: Quart) -> None:
    ...
    if hasattr(app, "quart_schema"):
        ...
        app_tags = [
            ...
            {
                "name": "Cat Facts",
                "description": "Cat fact retrieval and distribution operations",
            },
            {
                "name": "Email Deliveries",
                "description": "Email delivery tracking operations",
            },
            {
                "name": "Weekly Schedules",
                "description": "Weekly schedule management operations",
            },
